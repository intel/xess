...
namespace ParticleEffectManager
{
    ...
    void Update(ComputeContext& Context, float timeDelta );
    void Render(CommandContext& Context, const Math::Camera& Camera, ColorBuffer& ColorTarget, DepthBuffer& DepthTarget, ColorBuffer& ResponsiveMaskTarget, ColorBuffer& LinearDepth, bool isUpdateResponsiveMask = false);
