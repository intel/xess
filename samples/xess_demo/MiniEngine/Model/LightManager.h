...
namespace Lighting
{
    ...
    extern ByteAddressBuffer m_LightGridTransparent;
    extern ByteAddressBuffer m_LightGridBitMaskTransparent;
    ...
    void FillLightGrid(GraphicsContext& gfxContext, const Math::Camera& camera, bool transparent);
    void Shutdown(void);
}
